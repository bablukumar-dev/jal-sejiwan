      ...
      <main className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="w-20 h-20 rounded-2xl bg-emerald-100 border-2 border-emerald-500 overflow-hidden flex-shrink-0 relative">
            <Image src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${customer.name}`} alt={`${customer.name} - Active Client profile on JalSejiwan, India's leading 20 Litre Water Jar Delivery System`} fill className="object-cover" />
          </div>
