    ...
    <header className="bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50 w-full h-[60px]">
      ...
      <div className="flex justify-between items-center px-4 h-[60px] max-w-md mx-auto">
        ...
        <div className="flex items-center gap-3 shrink-0 ml-2">
          {hasAlerts && (
            <div id="onboarding-notifications" className="relative flex items-center">
          ...
          {showProfile && (
            <button 
              ...
              className="w-11 h-11 rounded-full overflow-hidden border-2 border-blue-600 bg-slate-100 flex items-center justify-center active:scale-95 transition-transform shrink-0 hover:bg-blue-50 cursor-pointer"
            >
